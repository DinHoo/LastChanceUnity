...
public class Player : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (other.transform.CompareTag("obj1") && ponto == 1)
            {
                ponto++;
                GameObject.Destroy(other.gameObject);
            }
            else if (other.transform.CompareTag("obj2") && ponto == 2)
            {
                ponto++;
                GameObject.Destroy(other.gameObject);
            }
            else if (other.transform.CompareTag("obj3") && ponto == 3)
            {
                ponto++;
                GameObject.Destroy(other.gameObject);
            }
            else if (other.transform.CompareTag("obj4") && ponto == 4)
            {
                ponto++;
                GameObject.Destroy(other.gameObject);
            }
            else if (other.transform.CompareTag("obj5") && ponto == 5)
            {
                ponto++;
                GameObject.Destroy(other.gameObject);
            }
            else if (other.transform.CompareTag("obj6") && ponto == 6)
            {
                ponto++;
                GameObject.Destroy(other.gameObject);
